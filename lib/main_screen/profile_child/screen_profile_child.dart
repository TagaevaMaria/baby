...
/*
Авторизация:
1. первая регистрация. Создать профиль ребенка---внести ребенка---внести родителя--попали на главный экран.
2.уже есть регистрация. уже создала-малыша---выбрала нужного ребенка--попали на главный экран с данными этого ребенка.
 */
